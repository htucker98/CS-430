...
public class Image {
    ...
    public void sutherlandHodgman() {
        ...
        for (int i = 0; i < this.points.size()-1; i = i + 2) {
            ...
            v_i = this.points.get(i);
            v_i1 = this.points.get(i + 1);
            ...
            //Case 2 : Output intersection point to P’’
                ...
                v_i1 = intersection(v_i, v_i1, "top");
                this.points.remove(i + 1);
                this.points.add(i + 1, v_i1);
            }
            ...
            //Case 4 : Output intersection point & vi+1 to P’’
                ...
                //find intersection with top boundary
                v_i = intersection(v_i, v_i1, "top");
                this.points.remove(i);
                this.points.add(i, v_i);
            }
        }

        //remove any points for lines completely outside of clip boundary
        for (int i=0; i<pointsToRemove.size();i++){
            this.points.remove(pointsToRemove.get(i)-i);
        }

        //check points for BOTTOM clip boundary
        clipBoundary = window.bottom;
        pointsToRemove = new ArrayList<Integer>();
        for (int i = 0; i < this.points.size()-1; i = i + 2) {
            ...
            //Case 2 : Output intersection point to P’’
                ...
                //find intersection with top boundary
                v_i1 = intersection(v_i, v_i1, "bottom");
                this.points.remove(i + 1);
                this.points.add(i + 1, v_i1);
            }
            ...
            //Case 4 : Output intersection point & vi+1 to P’’
                ...
                //find intersection with top boundary
                v_i = intersection(v_i, v_i1, "bottom");
                this.points.remove(i);
                this.points.add(i, v_i);
            }
        }
        ...
        for (int i = 0; i < this.points.size()-1; i = i + 2) {
            ...
            //Case 2 : Output intersection point to P’’
                ...
                //find intersection with top boundary
                v_i1 = intersection(v_i, v_i1, "right");
                this.points.remove(i + 1);
                this.points.add(i + 1, v_i1);
            }
            ...
            //Case 4 : Output intersection point & vi+1 to P’’
                ...
                //find intersection with top boundary
                v_i = intersection(v_i, v_i1, "right");
                this.points.remove(i);
                this.points.add(i, v_i);
            }
        }
        ...
        for (int i = 0; i < this.points.size()-1; i = i + 2) {
            ...
            //Case 2 : Output intersection point to P’’
                ...
                //find intersection with top boundary
                v_i1 = intersection(v_i, v_i1, "left");
                this.points.remove(i + 1);
                this.points.add(i + 1, v_i1);
            }
            ...
            //Case 4 : Output intersection point & vi+1 to P’’
                ...
                //find intersection with top boundary
                v_i = intersection(v_i, v_i1, "left");
                this.points.remove(i);
                this.points.add(i, v_i);
            }
        }
